...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body>
		<!-- MAIN_WRAPPER -->
		<div class="main-wrapper fullheight animsition">

			<!-- HEADER -->
			<header class="absolute">
				<!-- LOGO -->
				<a href="index-main.html" class="logo">
					<h3>Nativer</h3>
				</a>
				<!-- /LOGO -->
				...
				<nav id="topmenu">
					<ul>
						<li>
							...
							<ul>
								<li><a href="index-main.html">default</a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a href="portfolio-lightbox.html">lightbox</a></li>
								<li><a href="portfolio-fullwidth.html">fullwidth</a></li>
								<li><a href="portfolio-bigspaces.html">big spaces</a></li>
								<li><a href="portfolio-2cols.html">2 columns</a></li>
								<li><a href="portfolio-4cols.html">4 columns</a></li>
								<li><a href="portfolio-classic.html">classic</a></li>
								<li><a href="portfolio-filter.html">filter</a></li>
			...
			<div class="hero">
				<!-- HERO INNER -->
				<div class="hero-inner bg-cover" style="background-image: url('img/6.jpg')">
					...
					<div class="container fullheight text-light text-center">
						...
						<h6 class="title bold mrg-btm-20">page not found</h6>
						<a href="index-main.html" class="button outline light">go home</a>
						</div>
			...
			<footer id="footer">
				...
				<div class="copyright">&copy; 2015 Nativer.org</div>
